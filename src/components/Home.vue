    ...
    <div class="container py-5 mb-4">
      <div class="row text-center p-3">
        ...
        <div class="col-md-3">
          ...
          <h3 class="font-weight-bold m-3 text-uppercase h4">Chauffeurs professionnels</h3>
      ...
      <div class="py-5">
        ...
        <div class="row my-3">
          ...
          <div class="col-md-11">
            ...
            <p>Un de nos chauffeurs vient vous chercher à votre domicile et vous accompagne pour vos achats (magasin alimentaire, marché local, magasin de meubles...).</p>
