<template>
  <div class="container mt-5">
    ...
    <p>N'hésitez pas à nous <a href="/contact" >contacter</a> pour toute demande de renseignements, devis ou autres informations concernant la mise en place de contrats fixes pour des transports journaliers, hebdomadaires, mensuels ou sur toute l'année.</p>
