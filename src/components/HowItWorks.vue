<template>
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-6 py-2">
        <h4>RÉSERVER SUR NOTRE SITE, APPLICATION OU PAR TÉLÉPHONE</h4>
        <ul>
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-6 py-2">
        ...
        <ul>
          ...
          <li><strong>Groupe <i class="fa fa-users mx-1" aria-hidden="true"></strong> : <p>Si vous êtes plus de 3 personnes</p></li>
        </ul>
