  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-6 py-2">
        <img class="mx-auto d-block img-fluid" src="../assets/screenshot-reservation.jpg">
      </div>
      <div class="col-md-6 py-2">
    ...
    <div class="row mt-3">
      <img class="mx-auto d-block hidden-md-up img-fluid" src="../assets/screenshot-options.jpg">
      <div class="col-md-6 py-2">
        <h2>VOTRE COURSE</h2>
        <p>Transport One met à disposition les services suivant, sélectionner les au besoin.</p>
        <ul>
          <li><strong>Attente <i class="fa fa-pause-circle-o mx-1" aria-hidden="true"></i></strong> : <p>Notre chauffeur reste à votre disposition et vous attend (rendez-vous personel, médecin...) (10.-CHF/30 min).</p></li>
          <li><strong>Commision <i class="fa fa-shopping-basket mx-1" aria-hidden="true"></strong> : <p>Notre chauffeur vient vous chercher au domicile et vous accompagne pour vos achats (magasin alimentaire, marché local, magasin de meuble, ...). De plus, nous vous raccompagnons à domicile et vous aide à déposer les commissions effectuées chez vous. (15.-CHF/30 min)</p></li>
          <li><strong>Groupe <i class="fa fa-users mx-1" aria-hidden="true"></strong> : <p>Si vous êtes plus de 8 personnes</p></li>
        </ul>
        <p>“<strong>Commentaire</strong>”, Merci de nous faire part des éventuelles informations supplémentaires, entre autre si la personne est en fauteuil roulant ou par exemple si nous devons monter chercher la personne à son domicile.</p>
      ...
      <div class="col-md-6 py-2 hidden-sm-down">
        <img class="mx-auto d-block img-fluid" src="../assets/screenshot-options.jpg">
      </div>
    </div>
    <div class="row mt-3">
      <div class="col-md-6 py-2">
        <img class="mx-auto d-block img-fluid" src="../assets/screenshot-map.jpg">
      </div>
      <div class="col-md-6 py-2">
        <h2>RESERVATION</h2>
        <p>Le détail et le prix de la course s’affiche automatiquement. II ne vous reste donc plus qu&#39;à cliquer sur “<strong>Réserver</strong>”.</p>
    ...
    <div class="row mt-3">
      <img class="mx-auto d-block hidden-md-up img-fluid" src="../assets/screenshot-login.jpg">
      <div class="col-md-6 py-2">
      ...
      <div class="col-md-6 py-2 hidden-sm-down">
        <img class="mx-auto d-block img-fluid" src="../assets/screenshot-login.jpg">
      </div>
    </div>
  </div>
</template>
