  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-6 py-2">
        <img class="mx-auto d-block img-fluid" src="~assets/img/commentcamarche/screenshot-reservation.jpg" alt="reservation">
      </div>
      <div class="col-md-6 py-2">
        <h2 class="text-uppercase">Réserver sur notre site, via notre application ou par téléphone</h2>
        <ul>
    ...
    <div class="row mt-3">
      <div class="col-md-6 py-2">
        <img class="pb-3 mx-auto d-block hidden-md-up img-fluid" src="~assets/img/commentcamarche/screenshot-options.jpg" alt="options">
        <h2 class="text-uppercase">Votre course</h2>
        ...
        <ul>
          ...
          <li><strong>Commision <i class="fa fa-shopping-basket mx-1" aria-hidden="true"></i></strong> : <p>Notre chauffeur vient vous chercher au domicile et vous accompagne pour vos achats (magasin alimentaire, marché local, magasin de meuble...). De plus, nous vous raccompagnons à domicile et vous aidons à déposer les commissions effectuées chez vous. (15.-CHF/30 min)</p></li>
          <li><strong>Groupe <i class="fa fa-users mx-1" aria-hidden="true"></i></strong> : <p>Si vous êtes plus de 8 personnes</p></li>
        </ul>
      ...
      <div class="col-md-6 py-2 hidden-sm-down">
        <img class="mx-auto d-block img-fluid" src="~assets/img/commentcamarche/screenshot-options.jpg" alt="options">
      </div>
    </div>
    <div class="row mt-3">
      <div class="col-md-6 py-2">
        <img class="mx-auto d-block img-fluid" src="~assets/img/commentcamarche/screenshot-map.jpg" alt="map">
      </div>
      <div class="col-md-6 py-2">
        <h2 class="text-uppercase">Réservation</h2>
        <p>Le détail et le prix de la course s’affichent automatiquement. II ne vous reste donc plus qu'à cliquer sur « <strong>Réserver</strong> ».</p>
        <p><strong>Annulation gratuite</strong> : Vous disposez d'une annulation gratuite avec un préavis de 24 heures. <a href="/contact" >Contactez-nous</a> par téléphone ou par email.</p>
        <p>Nous vous invitons à cocher la case « <strong>Recevoir des offres par email</strong> » afin d’être averti de toutes nouveautés et modifications !</p>
      </div>
    </div>
    <div class="row mt-3">
      <div class="col-md-6 py-2">
        <img class="pb-3 mx-auto d-block hidden-md-up img-fluid" src="~assets/img/commentcamarche/screenshot-login.jpg" alt="login">
      ...
      <div class="col-md-6 py-2 hidden-sm-down">
        <img class="mx-auto d-block img-fluid" src="~assets/img/commentcamarche/screenshot-login.jpg" alt="login">
      </div>
    </div>
  </div>
</template>
